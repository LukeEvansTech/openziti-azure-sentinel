...
First, download "Azure Public Service Icons" from
...
redistributed in this repository. `make_icons.py` also fetches the OpenZiti
mark from `github.com/openziti.png`, so that step needs network access.

Next, install a rasteriser (`brew install librsvg` for `rsvg-convert`, or
